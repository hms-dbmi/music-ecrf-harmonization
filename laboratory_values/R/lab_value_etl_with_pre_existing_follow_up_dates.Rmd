...
out <- out %>% 
  ...
  mutate( cytokine_obtained = ifelse( tnf_alpha_obtained == 1 | il_1_obtained == 1 | il_2_obtained == 1 |
                                        ...
                                        il_19_obtained == 1 | ifn_gamma_obtained == 1 , 1, 0), 
          ...
          lympho_obtained = ifelse( cd3_abs_obtained == 1 | cd3_cd4_obtained == 1 | cd3_cd4_abs_obtained == 1 |
                                      cd3_cd8_obtained == 1 | cd3_cd8_abs_obtained == 1 | cd3_cd16_cd56_obtained == 1 | 
                                      cd19_obtained == 1 | cd19_abs_obtained == 1 | ac4_cd8_ratio_obtained == 1, 1, 0), 
          other_labs = 0
)
```
