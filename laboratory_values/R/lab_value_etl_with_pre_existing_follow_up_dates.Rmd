...
finalTable$lab_values_visit <- ifelse( finalTable$date == finalTable$ADMISSION_DATE, 1, 
                                       ifelse( finalTable$date == finalTable$DISCHARGE_DATE, 2, 
                                               ifelse( finalTable$date == finalTable$two_weeks, 3, 
                                                       ifelse( finalTable$date == finalTable$six_weeks, 4, 
                                                               ifelse( finalTable$date == finalTable$six_months, 6, NA)))))
