...
write.table( lab_data, 
             file ="../local_ref/texasChildren/misc_lab_observations.tsv",
             col.names = TRUE, 
             row.names = FALSE, 
             sep       = "\t", 
             quote     = FALSE )
...
write.table( med_data, 
             file ="../local_ref/texasChildren/misc_med_data_observations.tsv",
             col.names = TRUE, 
             row.names = FALSE, 
             sep       = "\t", 
             quote     = FALSE )
...
write.table( concept_dimension, 
             file ="../local_ref/texasChildren/concept_dimension.tsv",
             col.names = TRUE, 
             row.names = FALSE, 
             sep       = "\t", 
             quote     = FALSE )
