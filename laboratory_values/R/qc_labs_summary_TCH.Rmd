...
check_summary$units_cd_transformed <- gsub( "SEC", "seconds", check_summary$units_cd_transformed)
check_summary$units_cd_transformed <- gsub( "NG/ML", "ng/mL", check_summary$units_cd_transformed)
check_summary$units_cd_transformed <- gsub( "mm/h", "mm/hr", check_summary$units_cd_transformed)
check_summary$units_cd_transformed <- gsub( "hrr", "hr", check_summary$units_cd_transformed)
check_summary$units_cd_transformed <- gsub( "(calc)", "", check_summary$units_cd_transformed)
