...
ft5 <- ft4 %>% 
  ...
  group_by(MUSIC_ID) %>%
  arrange(ECRF_CODE) %>%
  mutate(redcap_repeat_instance = match(ECRF_CODE, unique(ECRF_CODE))) %>%
...
out4 <- out3 %>%
  mutate(medcur1_current___1 = ifelse(medcur1_current___0 & medcur1_current___2, 1, 0),
         medcur1_current___2 = ifelse(medcur1_current___1 & medcur1_current___3, 1, 0),
         medcur1_current___3 = ifelse(medcur1_current___2 & medcur1_current___4, 1, 0),
         medcur1_current___4 = ifelse(medcur1_current___3 & medcur1_current___5, 1, 0),
         medcur1_current___5 = ifelse(medcur1_current___4 & medcur1_current___6, 1, 0))
...
write.csv(out3 %>% 
            filter(record_id %in% c(120006, 120002)) %>% 
