...
bch_med_concept_summary %>%
  group_by(CONCEPT_CD, BCH_CONCEPT_PATH, BCH_CONCEPT_DESCRIPTION) %>%
  summarise(n_eCRF_mappings = n_distinct(ECRF_CODE)) %>%
...
The rest of the BCH codes map to 8 or fewer eCRF codes. They will be left in the mapping and summary table for manual review.
