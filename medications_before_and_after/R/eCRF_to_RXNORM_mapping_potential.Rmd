...
```{r}
write.csv(bch_med_concept_summary, '../data/bch_med_concept_summary_with_concept_paths.csv')
...
write.csv(bch_med_concept_summary, '../data/bch_med_concept_summary_toReview.csv')
