...
library(tidyverse)
library(lubridate)
lab_dictionary <- read.delim("labDictionary.txt", header = TRUE)
...
Questions for Paul
- did he understand those columns?
- how to make this an automatic pipeline: what format are the lab codes in BCH so we can use UMLS?
- secure file transfer?
- loading data dict and mapping files to github?
