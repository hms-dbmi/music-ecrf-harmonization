...
check_summary$checkUnits <- ifelse( check_summary$units_cd_transformed ==  check_summary$Field.Note, "OK", "To check")
...
write.table(check_summary, file="check_summary_v1.txt", col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t")
```
