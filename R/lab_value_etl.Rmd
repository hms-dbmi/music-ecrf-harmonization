...
```{r}
# create dummy df for mapping variable prefix to whether high or low is worst, in this case all are 'high'
worst_values <- data.frame(prefix = unique(finalTable$prefix), worst = 'high')
