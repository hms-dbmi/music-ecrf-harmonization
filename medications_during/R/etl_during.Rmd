...
out <- pivot_wider(df3,
                  id_cols = c(PATIENT_NUM, medhospX_type, medhospX_start_dt, redcap_repeat_instance, med_num),   
...
write.csv(out4 %>%
            filter(record_id %in% c(120002, 120003)) %>%
            mutate(record_id = ifelse(record_id == 120002, 888002, 888003)),
