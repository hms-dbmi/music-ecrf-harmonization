...
# Missing vars
```{r}
data_dictionnary$Variable...Field.Name[which(!data_dictionnary$Variable...Field.Name %in% colnames(out))]
...
write.csv(out %>% select(-PATIENT_NUM), "../local_ref/redcap_output_demographics.csv", row.names = FALSE)
```
